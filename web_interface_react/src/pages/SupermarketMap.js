...
import mapImage from "../images/SupermarketMap.png"; // Ensure this is the path to your map image file
...
const SupermarketMap = () => {
  ...
  const stockCoordinates = {
    ...
    'Stock11': [120, 360],
    'Stock12': [120, 240],
    // Add the rest of the stocks with their fixed coordinates
  };
  ...
  const handleRoomSelectionSubmit = (e) => {
    e.preventDefault();
    if (selectedRoom) {
      const end = stockCoordinates[selectedRoom];
  ...
  return (
    <div className="container">
      <div>
        <h1>Welcome to the Supermarket Navigation System</h1>
          ...
          <form onSubmit={handleRoomSelectionSubmit}>
            <label>
              ...
              <select
                ...
                required
              >
                <option value="">Select a stock section...</option>
                {Object.keys(stockCoordinates).map((roomNumber) => (
